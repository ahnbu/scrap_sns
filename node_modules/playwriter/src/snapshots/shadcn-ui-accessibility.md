...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e25]:
      - generic [ref=e26]:
        - generic [ref=e29]:
          - link "Base UI Documentation" [ref=e30] [cursor=pointer]:
            - /url: /docs/changelog
            - img
            - text: Base UI Documentation
            - img
          - heading "The Foundation for your Design System" [level=1] [ref=e31]
          - paragraph [ref=e32]: A set of beautifully designed components that you can customize, extend, and build on. Start here then make it your own. Open Source. Open Code.
          - generic [ref=e33]:
            - link "Get Started" [ref=e34] [cursor=pointer]:
              - /url: /docs/installation
            - link "View Components" [ref=e35] [cursor=pointer]:
              - /url: /docs/components
        - generic [ref=e37]:
          - generic [ref=e42]:
            - link "Examples" [ref=e43] [cursor=pointer]:
              - /url: /
            - link "Dashboard" [ref=e44] [cursor=pointer]:
              - /url: /examples/dashboard
            - link "Tasks" [ref=e45] [cursor=pointer]:
              - /url: /examples/tasks
          ...
          - generic [ref=e48]:
            - generic [ref=e49]: Theme
            - combobox "Theme" [ref=e50]:
