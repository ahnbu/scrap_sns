...
- `_docs/architecture.md` — 플랫폼별 데이터 구조·수집 흐름, 표준 스키마, 병합, 뷰어·API surface
...
- LinkedIn 수집 배열 순서는 화면 순서와 무관하다. 순서 관련 변경 전 `_docs/architecture.md`의 LinkedIn 수집 순서 항목을 확인한다.
